...
function ManageMenu() {
  ...
  // ============================================================
  // ✅ FIXED: ADD MISSING FUNCTIONS HERE
  // ============================================================
  ...
  return (
    <Sidebar>
      <div style={{ 
        ...
        {/* ========================================================== */}
        {/* SPECIAL TAB - Keep your existing */}
        {/* ========================================================== */}
        {activeTab === 'special' && (
          <div>
            {/* ... your existing special tab code ... */}
          </div>
        )}

        {/* ========================================================== */}
        {/* PROMOTIONS TAB - Keep your existing */}
        {/* ========================================================== */}
        {activeTab === 'promotions' && (
          <div>
            {/* ... your existing promotions tab code ... */}
          </div>
        )}
        ...
        {showAddSpecialModal && (
          <div style={modalOverlayStyle}>
            {/* ... your existing add special modal ... */}
          </div>
        )}
        ...
        {showEditSpecialModal && selectedSpecialItem && (
          <div style={modalOverlayStyle}>
            {/* ... your existing edit special modal ... */}
          </div>
        )}
        ...
        {showOptionsModal && selectedMenuForOptions && (
          <div style={modalOverlayStyle}>
            {/* ... your existing size options modal ... */}
          </div>
        )}
        ...
        {showAddPromoModal && (
          <div style={modalOverlayStyle}>
            {/* ... your existing add promotion modal ... */}
          </div>
        )}

        {showEditPromoModal && selectedPromo && (
          <div style={modalOverlayStyle}>
            {/* ... your existing edit promotion modal ... */}
          </div>
        )}
